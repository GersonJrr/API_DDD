...
namespace TestProjectApiDDD
{
    ...
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7260/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7260/api/CriarToken";

            using (var cliente = new HttpClient())
            {
                string login = "UsuarioTeste@gmail.com";
